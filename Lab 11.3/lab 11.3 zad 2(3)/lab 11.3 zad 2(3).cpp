...
//3. Заповнити квадратну матрицю випадковими числами(функція).Знайти середнє арифметичне головної діагоналі(функція) 
//і кількість елементів у першому рядку, менших цього середнього арифметичного.
